        ...
        <div class="layer"></div>
            <div class="col-md-12">
             ...
             <span class="sucess_msg hidden"> </span>  
	           <div class="site_logo"><img src="{{ url('images/logo.svg') }}" alt="site-logo"></div> 
			 ...
			 <div class="uplod_input">
                          ...
                          <div class="form_input">  
                           ...
                           <div class="form-group ">
							...
							<div class="form-group">
								<input type="number" name="download_fee" required placeholder="Enter Download fee" @if(!empty($download_fee)) <?php echo 'value="'.$download_fee . '"'; ?> @endif/>	
							</div>
							<div class="form-group">
								<input type="email" name="paypal_email" required placeholder="Enter paypal email" 
								value="<?php if(!empty($paypal_email)) echo $paypal_email; ?>" />	
							</div>
							@if(empty($id))
							<div class="form-group">
								<input style="width: 22px;" type="checkbox" value="1" name="term" required/> Accept Term & Condition
							</div>
							@endif
                            @if( !empty($id))
			         ...
			         @endif
                        ...
                        <div class="form_footer col-md-12">
                            ...
                            <button  class="tranfer_btn" >@if(empty($id)) Transfer @else Update @endif  </button>  
							 @if( !empty($id))
								  <input type="submit" name="delete_file" value="DELETE FILE NOW" class="delete_btn btn" />  
							 @endif
                        </div>
